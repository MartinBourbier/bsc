...
impl Into<TokenKind> for CToken {
    fn into(self) -> TokenKind {
        match self {
            Self::Alignas => TokenKind::_Alignas,
            Self::Alignof => TokenKind::_Alignof,
            Self::Atomic => TokenKind::_Atomic,
            Self::Auto => TokenKind::Auto,
            Self::Bool => TokenKind::_Bool,
            Self::Break => TokenKind::Break,
            Self::Case => TokenKind::Case,
            Self::Char => TokenKind::Char,
            Self::Complex => TokenKind::_Complex,
            ...
            Self::StaticAssert => TokenKind::_StaticAssert,
            Self::Struct => TokenKind::Struct,
            Self::Switch => TokenKind::Switch,
            Self::ThreadLocal => TokenKind::_ThreadLocal,
            ...
            Self::RightAssign => TokenKind::RightAssign,
            Self::LeftAssign => TokenKind::LeftAssign,
